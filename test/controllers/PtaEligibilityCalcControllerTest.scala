...
class PtaEligibilityCalcControllerTest extends UnitSpec with TestUtility {
  ...
  "Check eligibility benefit" should {
    ...
    "be GBP 212 if transferor income=0 (< 9540) and recipient income=12060 (10600-11660)" in new WithApplication(fakeApplication) {
    ...
    "be GBP 200 if transferor income=9000 (< 9540) and recipient income=12000 (> 11660)" in new WithApplication(fakeApplication) {
    ...
    "be GBP 130 if transferor income=9580 (9540-11000) and recipient income=11650 (11000-11660)" in new WithApplication(fakeApplication) {
    ...
    "be negative (12) if transferor income=11000 (9540-11000) and recipient income=12000 (11000-11660)" in new WithApplication(fakeApplication) {
    ...
    "be GBP 200 if transferor income=10000 (9540-11000) and recipient income=20000 (11660-42385)" in new WithApplication(fakeApplication) {
  ...
  "When transferor income is in different format, calculation" should {
    ...
    "be GBP 80 if transferor income=9000.05 (< 9540) and recipient income=11400 (10600-11660)" in new WithApplication(fakeApplication) {
      val result = calculatorRequestAction(Map("transferor-income" -> "9000.05", "recipient-income" -> "11400"))
      val document = Jsoup.parse(contentAsString(result))
      document.getElementById("calculator-result").text() shouldBe "Based on the information you have given us, as a couple you would benefit by around £80 a year."
    }

    "be GBP 80 if transferor income=9,000.05 (< 9540) and recipient income=11400 (10600-11660)" in new WithApplication(fakeApplication) {
  ...
  "Check validation message" should {
    ...
    "be displayed if transferor income=9000 (< 9540) and recipient income=5000 (< 11000)" in new WithApplication(fakeApplication) {
    ...
    "be displayed if transferor income=9000 (< 9540) and recipient income=45000 (> 43000)" in new WithApplication(fakeApplication) {
      val result = calculatorRequestAction(Map("transferor-income" -> "9000", "recipient-income" -> "45000"))
      val document = Jsoup.parse(contentAsString(result))
      document.getElementById("calculator-result").text() shouldBe "You are not eligible for Marriage Allowance. Your spouse or civil partner's annual income must be between £11,001 and £43,000."
    }

    "be displayed if transferor income=10000 (9540-10600) and recipient income=44000 (> 43000)" in new WithApplication(fakeApplication) {
      val result = calculatorRequestAction(Map("transferor-income" -> "10000", "recipient-income" -> "44000"))
      val document = Jsoup.parse(contentAsString(result))
      document.getElementById("calculator-result").text() shouldBe "You are not eligible for Marriage Allowance. Your spouse or civil partner's annual income must be between £11,001 and £43,000."
    }
    "be displayed if transferor income=11001 (>11000) and recipient income=20000" in new WithApplication(fakeApplication) {
    ...
    "be displayed if transferor income=43001 (>42385) and recipient income=20000" in new WithApplication(fakeApplication) {
