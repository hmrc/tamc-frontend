...
class ContentTest extends ControllerBaseTest {
  ...
  "Calling Transfer Submit page" should {
    ...
    "display form error message (first name and last name missing from request)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(
        "gender"           -> "M",
        "nino"             -> Ninos.nino1,
  ...
  "Calling Previous year page " should {
    ...
    "display dynamic message " in {
      ...
      when(
        ...
        .thenReturn(Nil)
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "applyForCurrentYear" -> "true")
    ...
    "display form error message (no year choice made )" in {
      ...
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "year" -> "List(0)")
  ...
  "Calling Confirm email page with error in email field" should {
    ...
    "display form error message (transferor email is empty)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "transferor-email" -> "")
      val result = transferController.confirmYourEmailAction(request)
    ...
    "display form error message (transferor email contains more than 100 characters)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody("transferor-email" -> s"${"a" * 90}@bbbb.ccccc")
      val result = transferController.confirmYourEmailAction(request)
    ...
    "display form error message (transferor email is invalid)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "transferor-email" -> "example")
      val result = transferController.confirmYourEmailAction(request)
    ...
    "display form error message (transferor email has consequent dots)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody("transferor-email" -> "ex..ample@example.com")
      val result = transferController.confirmYourEmailAction(request)
    ...
    "display form error message (transferor email has symbols). Please note, this email actually is valid" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "transferor-email" -> "check[example.com")
      val result = transferController.confirmYourEmailAction(request)
    ...
    "display form error message (transferor email does not include TLD)" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withFormUrlEncodedBody(data = "transferor-email" -> "example@example")
      val result = transferController.confirmYourEmailAction(request)
  ...
  "PTA partners income check page for multiyear" should {
    ...
    "have partners-income page and content for Scottish resident" in {
      val request = FakeRequest().withMethod("POST").withMethod("POST").withMethod("POST").withMethod("POST").withSession("scottish_resident" -> "true")
      val result = eligibilityController.partnersIncomeCheck()(request)
