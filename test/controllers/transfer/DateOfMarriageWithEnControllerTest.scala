...
class DateOfMarriageWithEnControllerTest extends ControllerBaseTest {
  ...
  def controller: DateOfMarriageWithEnController =
    app.injector.instanceOf[DateOfMarriageWithEnController]
