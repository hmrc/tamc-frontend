...
class DoNotApplyControllerTest extends ControllerBaseTest with ControllerViewTestHelper with Injecting {
  ...
  val doNotApplyView: dont_apply_current_tax_year = inject[views.html.multiyear.transfer.dont_apply_current_tax_year]
