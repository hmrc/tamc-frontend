...
//      val trrec = UserRecord(cid = Cids.cid1, timestamp = "2015", name = None)
//      val rcrec = UserRecord(cid = Cids.cid5, timestamp = "2015", name = None)
//      val recipientDetails = RecipientDetailsFormInput("foo", "bar", Gender("F"), Nino(Ninos.ninoWithLOA1))
//      val recrecord = RecipientRecord(record = rcrec, data = RegistrationFormInput(recipientDetails.name, recipientDetails.lastName, recipientDetails.gender, recipientDetails.nino, new LocalDate(2016,4,10)))
