...
class MarriageAllowanceConnectorSpec extends ControllerBaseSpec with WireMockHelper {

  lazy val httpClient = app.injector.instanceOf[DefaultHttpClient]
  def marriageAllowanceConnector = new MarriageAllowanceConnector(httpClient)
