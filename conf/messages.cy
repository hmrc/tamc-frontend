...
pages.form.field.dom.error.enter_numbers=Mae’n rhaid i ddyddiad y briodas neu ffurfio’r bartneriaeth sifil fod yn ddyddiad go iawn
...
title.confirm=Gwiriwch eich atebion cyn anfon eich cais
...
title.error=Gwall
title.error.transferor.not.found=Gwall: Ni allwn ddod o hyd i fanylion eich Lwfans Priodasol
title.error.recipient.not.found=Gwall: Ni allwn ddod o hyd i fanylion CThEF eich partner
...
# Finished Message
#********************************************************************************
pages.finished.complete=Cais am Lwfans Priodasol wedi’i gwblhau
pages.finished.para1.email1=Bydd e-bost cadarnhau yn cael ei anfon at {0}
pages.finished.para1.email2=cyn pen 24 awr.
pages.finished.para2=Os na allwch ddod o hyd i’r e-bost yn eich mewnflwch, gwiriwch eich ffolderi sbam neu sothach.
pages.finished.now=Yr hyn sy’n digwydd nesaf
pages.finished.para4=Bydd CThEF yn adolygu’ch cais. Os ydych yn gymwys, bydd CThEF yn newid eich cod treth a chod treth {0}
pages.finished.para4.2= er mwyn arbed hyd at £{1} i {0}.
pages.finished.para5=Mae Lwfans Priodasol yn adnewyddu bob blwyddyn oni bai eich bod chi neu {0} yn ei ganslo, neu os nad ydych yn bellach yn gymwys.
pages.finished.para6=Mae’r e-bost cadarnhau yn cynnwys yr holl fanylion am sut y byddwch yn cael Lwfans Priodasol.
...
transferor.not.found=Ni allwn ddod o hyd i fanylion eich Lwfans Priodasol
transferor.not.found.para1=Os oes angen i chi newid eich Lwfans Priodasol,
transferor.not.found.para1.link-text= cysylltwch ag ymholiadau cyffredinol Treth Incwm CThEF.
recipient.not.found=Ni allwn ddod o hyd i fanylion CThEF eich partner
recipient.not.found.para1.link-text=Gwiriwch fod gwybodaeth eich partner yn gywir
recipient.not.found.para1=a diweddarwch eich cais.
...
# claims page
#********************************************************************************
pages.claims.title=Eich hawliadau am Lwfans Priodasol
pages.claims.table.heading.tax-year=Blwyddyn dreth
...
pages.divorce.date.hint=Er enghraifft, 30 6 2019
...
pages.confirm.application.details=Manylion y cais
pages.confirm.date.of.marriage=Dyddiad y briodas neu’r dyddiad y ffurfiwyd y bartneriaeth sifil
pages.confirm.application.now=Cadarnhau eich cais nawr
pages.confirm.application.now.p=Drwy anfon eich cais, rydych yn cadarnhau, hyd eithaf eich gwybodaeth, bod y manylion yr ydych yn eu darparu’n gywir.
...
#*************************************************************
# Lower Earner Question Page
#*************************************************************
lowerEarner.title=Are you the lower earner?
lowerEarner.heading=Are you the lower earner?
lowerEarner.error.required=Select Yes if you are the lower earner

#*************************************************************
# Your total income question page
#*************************************************************
yourTotalIncome.title=Your total income
yourTotalIncome.heading=Your total income
yourTotalIncome.error.required=Select Yes if your total income is less than £12,570 a year
yourTotalIncome.p1=This is the total income you get before Income Tax and National Insurance is taken off.
yourTotalIncome.p2=Include employment, pensions, taxable state benefits, rental profits, savings, dividends and trusts.
yourTotalIncome.legend=Is your total income less than £12,570 a year?

#*************************************************************
# Invalid income page
#*************************************************************
invalidIncome.title=Your income must be less than £12,570 to apply
invalidIncome.heading=Your income must be less than £12,570 to apply
invalidIncome.p1=To benefit from Marriage Allowance as a couple, your income must be less than your Personal Allowance of £12,570.
invalidIncome.p2=If your income changes you can use the {0} to work out how much you could save as a couple.
invalidIncome.linkText=Marriage Allowance calculator

#*************************************************************
# Partner needs to apply page
#*************************************************************
partnerMustApply.title=Your partner needs to apply for Marriage Allowance
partnerMustApply.heading=Your partner needs to apply for Marriage Allowance
partnerMustApply.p1=If you are not the lower earner, your partner needs to apply if they qualify.
partnerMustApply.p2=They can apply to transfer some of their Personal Allowance to you.
partnerMustApply.p3=To do this, your partner can sign in to or set up their personal tax account, or {0}.
partnerMustApply.linkText=apply for Marriage Allowance by post